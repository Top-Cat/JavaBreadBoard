...
public class Gen74138 extends IntegratedCircuit {
	...
	private void initialise() {
		...
		this.diagram = "images" + File.separator + "74138.gif";
		this.wide = false;

		this.pins.add(new InputPin(1, "A"));
		this.pins.add(new InputPin(2, "B"));
		this.pins.add(new InputPin(3, "C"));
		this.pins.add(new InputPin(4, "nG2A"));
		this.pins.add(new InputPin(5, "nG2B"));
	...
	private void updateGate(String A, String B, String C, String nG2A, String nG2B, String G1, String Y0, String Y1, String Y2, String Y3, String Y4, String Y5, String Y6, String Y7) throws InvalidPinException {
		if (this.isHigh(nG2A) || this.isHigh(nG2B) || this.isLow(G1)) {
	...
	public void simulate() {
		try {
			if (this.isPowered()) {
				this.updateGate("A", "B", "C", "nG2A", "nG2B", "G1", "Y0", "Y1", "Y2", "Y3", "Y4", "Y5", "Y6", "Y7");
			} else {
 ...
 * \classes\ Qualified Name: integratedCircuits.ttl.decoder.Gen74138 JD-Core
 * Version: 0.6.2
 */
