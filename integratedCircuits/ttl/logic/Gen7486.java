...
/*    */   {
/* 48 */     this.description = "Quadruple 2-Input Positive-XOR Gates";
/* 49 */     this.manufacturer = "Generic TTL gate";
/* 50 */     this.diagram = ("images" + File.separator + "7486.gif");
/* 51 */     this.wide = false;
/*    */ 
...
/* 66 */     if (((isHigh(A)) && (isHigh(B))) || ((isLow(A)) && (isLow(B)))) {
 ...
 * Qualified Name:     integratedCircuits.ttl.logic.Gen7486
