...
public class Gen7432 extends IntegratedCircuit {
	...
	private void initialise() {
		this.description = "Quadruple 2-Input Positive-OR Gates";
		this.manufacturer = "Generic TTL gate";
		this.diagram = "images" + File.separator + "7432.gif";
		this.wide = false;
 ...
 * \classes\ Qualified Name: integratedCircuits.ttl.logic.Gen7432 JD-Core
 * Version: 0.6.2
 */
