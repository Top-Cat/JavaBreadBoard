...
/*    */   {
/* 44 */     this.description = "Dual 4-Input Positive-AND Gates";
/* 45 */     this.manufacturer = "Generic TTL gate";
/* 46 */     this.diagram = ("images" + File.separator + "7421.gif");
/* 47 */     this.wide = false;
/*    */ 
...
/* 66 */       setPin(Y, Pin.PinState.HIGH);
/*    */     }
/*    */     else
/* 69 */       setPin(Y, Pin.PinState.LOW);
/*    */   }
/*    */ 
/*    */   public void reset()
/*    */   {
 ...
 * Qualified Name:     integratedCircuits.ttl.logic.Gen7421
