...
/*    */   {
/* 46 */     this.description = "Triple 3-Input Positive-NOR Gates";
/* 47 */     this.manufacturer = "Generic TTL gate";
/* 48 */     this.diagram = ("images" + File.separator + "7427.gif");
/* 49 */     this.wide = false;
/*    */ 
...
/*    */   {
/* 66 */     if ((isLow(A)) && (isLow(B)) && (isLow(C))) {
/* 67 */       setPin(Y, Pin.PinState.HIGH);
/*    */     }
/*    */     else
/* 70 */       setPin(Y, Pin.PinState.LOW);
/*    */   }
/*    */ 
/*    */   public void reset()
/*    */   {
 ...
 * Qualified Name:     integratedCircuits.ttl.logic.Gen7427
