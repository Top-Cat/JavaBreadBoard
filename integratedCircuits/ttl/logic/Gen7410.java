...
public class Gen7410 extends IntegratedCircuit {
	...
	private void initialise() {
		this.description = "Triple 3-Input Positive-NAND Gates";
		this.manufacturer = "Generic TTL gate";
		this.diagram = "images" + File.separator + "7410.gif";
		this.wide = false;
 ...
 * \classes\ Qualified Name: integratedCircuits.ttl.logic.Gen7410 JD-Core
 * Version: 0.6.2
 */
