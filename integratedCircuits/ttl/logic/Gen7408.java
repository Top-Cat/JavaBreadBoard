...
public class Gen7408 extends IntegratedCircuit {
	...
	private void initialise() {
		this.description = "Quadruple 2-Input Positive-AND Gates";
		this.manufacturer = "Generic TTL gate";
		this.diagram = "images" + File.separator + "7408.gif";
		this.wide = false;
 ...
 * \classes\ Qualified Name: integratedCircuits.ttl.logic.Gen7408 JD-Core
 * Version: 0.6.2
 */
