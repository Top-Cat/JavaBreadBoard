...
public class JBreadBoard extends JApplet {
	...
	public static ChipModel getChipModel(String s) {
		...
		if (chipModel != null) {
			try {
				...
				if (JBreadBoard.implementsInterface((ChipModel) object, "uk.ac.york.jbb.jbreadboard.v1_00.ChipModel")) {
	...
	private JToolBar buildToolBar() {
		...
		JButton button = new JButton(this.getImageIcon("uk/ac/york/jbb/images/new.gif"));
		button.setToolTipText("New");
		button.setActionCommand("new");
		button.addActionListener(this.jbbal);
		toolbar.add(button);

		button = new JButton(this.getImageIcon("uk/ac/york/jbb/images/open.gif"));
		button.setToolTipText("Open");
		button.setActionCommand("load");
		button.addActionListener(this.jbbal);
		toolbar.add(button);

		button = new JButton(this.getImageIcon("uk/ac/york/jbb/images/save.gif"));
		...
		button = new JButton(this.getImageIcon("uk/ac/york/jbb/images/select.gif"));
		button.setToolTipText("Selector");
		button.setActionCommand("select");
		button.addActionListener(this.jbbal);
		toolbar.add(button);

		button = new JButton(this.getImageIcon("uk/ac/york/jbb/images/del.gif"));
		...
		button = new JButton(this.getImageIcon("uk/ac/york/jbb/images/newb.gif"));
		button.setToolTipText("Insert BreadBoard");
		button.setActionCommand("breadboard");
		button.addActionListener(this.jbbal);
		toolbar.add(button);

		button = new JButton(this.getImageIcon("uk/ac/york/jbb/images/chip.gif"));
		button.setToolTipText("Add Chip");
		button.setActionCommand("defaultchip");
		button.addActionListener(this.jbbal);
		toolbar.add(button);

		button = new JButton(this.getImageIcon("uk/ac/york/jbb/images/chipq.gif"));
		button.setToolTipText("Select and Add Chip");
		button.setActionCommand("chip");
		button.addActionListener(this.jbbal);
		toolbar.add(button);

		button = new JButton(this.getImageIcon("uk/ac/york/jbb/images/wire.gif"));
		...
		button = new JButton(this.getImageIcon("uk/ac/york/jbb/images/led.gif"));
		button.setToolTipText("Add LED");
		button.setActionCommand("led");
		button.addActionListener(this.jbbal);
		toolbar.add(button);

		button = new JButton(this.getImageIcon("uk/ac/york/jbb/images/dip.gif"));
		...
		button = new JButton(this.getImageIcon("uk/ac/york/jbb/images/reset.gif"));
		button.setToolTipText("Reset Simulation");
		button.setActionCommand("reset");
		button.addActionListener(this.jbbal);
		toolbar.add(button);

		button = new JButton(this.getImageIcon("uk/ac/york/jbb/images/pause.gif"));
		button.setToolTipText("Pause Simulation");
		button.setActionCommand("pause");
		button.addActionListener(this.jbbal);
		toolbar.add(button);

		button = new JButton(this.getImageIcon("uk/ac/york/jbb/images/step.gif"));
		button.setToolTipText("Step Simulation");
		button.setActionCommand("step");
		button.addActionListener(this.jbbal);
		toolbar.add(button);

		button = new JButton(this.getImageIcon("uk/ac/york/jbb/images/run.gif"));
	...
	public String[] getToolList() {
		URL url = ClassLoader.getSystemResource("uk/ac/york/jbb/tools");
