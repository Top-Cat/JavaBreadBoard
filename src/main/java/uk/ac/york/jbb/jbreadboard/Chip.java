...
import uk.ac.york.jbb.jbreadboard.v1_10.Clickable;
...
public class Chip extends JComponent implements Device, CircuitSelection {
	...
	public Chip(Circuit c, ChipModel m) {
		this.circuit = c;
		if (m == null) {
			this.model = JBreadBoard.getChipModel("uk.ac.york.jbb.integratedcircuits.ttl.logic.Gen7400");
		} else {
			this.model = m;
		}
		...
		this.dblClickable = JBreadBoard.implementsInterface(this.model, "uk.ac.york.jbb.jbreadboard.v1_10.DblClick");
		this.loadSaveable = JBreadBoard.implementsInterface(this.model, "uk.ac.york.jbb.jbreadboard.v1_10.LoadSave");
		this.graphical = JBreadBoard.implementsInterface(this.model, "uk.ac.york.jbb.jbreadboard.v1_10.Graphical");
		this.clickable = JBreadBoard.implementsInterface(this.model, "uk.ac.york.jbb.jbreadboard.v1_10.Clickable");
		this.sized = JBreadBoard.implementsInterface(this.model, "uk.ac.york.jbb.jbreadboard.v1_10.Sized");
	}
	...
	public String getDiagram() {
		...
		fileName = fileName + '/' + this.model.getDiagram();
